...
class Camera:
    ...
    def _validate_image(self, image):
        ...
        assert image_size == self.camera_image_size, "Can't process image taken by different camera"

    def load_calibration_images(self, nx=9, ny=6, path_pattern="./input/calibration_calibration/calibration*.jpg"):
        ...
        for image_path in image_paths:
            ...
            if patternWasFound is True:
                ...
                print("Image [{}] has intersection pattern different from 9x5 and will be skipped".format(image_path))
    ...
    def calibrate(self):
        ...
        success, self.camera_matrix, self.dist_coefficients, rvecs, tvecs = result

        assert success is True, "Camera calibration failed"
