...
t_parameters = TransformationParameters(w, h, vanishing_point_distance, x_meters_per_pixel, max_distance_coefficient)
perspective_transform = PerspectiveTransformationOperation(t_parameters)
